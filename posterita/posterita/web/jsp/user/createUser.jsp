...
<tiles:insert page="/jsp/include/headerTableTop.jsp">
  	<tiles:put name="title"><bean:message key="user.create"/></tiles:put>
</tiles:insert>
 ...
 <table width="100%" border="0" cellpadding="5" cellspacing="1" align="center">
			<tr>
				<td> 
					<%@ include file="/jsp/include/tabTop.jsp" %><bean:message key="user.create"/><%@ include file="/jsp/include/tabBottom.jsp" %>
				</td>
			</tr>
				...
				<td>		
					...
					<html:form action="/CreateUserAction">
						<html:hidden property="action" value="createUser"/>
							...
							<table align="left" width="350" border="0" cellpadding="5" cellspacing="0" cols="2">
							   <tr>
									<td>Role</td>
									<td colspan="2">
								...
								<tr>			
									...
									<td colspan="1"><html:text property="username"/>
									</td>
								</tr>
