...
<%@ page import="com.posterita.Constants" %>
<%@ page import="com.posterita.user.WebUserInfo" %>
<%@ page import="com.posterita.order.UDIOrderTypes" %>
...
--%>
	<table width="100%" border="0" cellpadding="5" cellspacing="0" class="orderheader">
		...
		<%@ include file="/jsp/webstore/webDocumentHeader.jsp" %>
