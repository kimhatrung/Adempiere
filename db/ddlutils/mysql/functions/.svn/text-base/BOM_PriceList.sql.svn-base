 ...
 * Test..........: SELECT bomPriceList(123, 105)$$ => 59.5500000000
 *                 SELECT bomPriceList(124, 105)$$ => 54.5500000000
 * 
...
-- ## Drop statement
DROP PROCEDURE IF EXISTS bomPriceListProc $$

-- ## Create statement
CREATE PROCEDURE bomPriceListProc (
       Product_ID             DECIMAL(10, 0),
       PriceList_Version_ID   DECIMAL(10, 0),
  OUT  bomPriceList           DECIMAL(20, 10)
)
  DETERMINISTIC
proc: BEGIN
  ...
  SELECT COALESCE(pp.PriceList, 0)
    INTO v_Price
  ...
  SET bomPriceList = v_Price;
END$$


DROP FUNCTION IF EXISTS bomPriceList
$$

CREATE FUNCTION bomPriceList (
