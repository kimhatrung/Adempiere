 ...
 * Test..........: SELECT bomPriceStd(123, 105)$$ => 56.5700000000
 *                 SELECT bomPriceStd(124, 105)$$ => 51.8200000000
 * 
...
-- ## Drop statement
DROP PROCEDURE IF EXISTS bomPriceStdProc $$

-- ## Create statement
CREATE PROCEDURE bomPriceStdProc (
       Product_ID             DECIMAL(10, 0),
       PriceList_Version_ID   DECIMAL(10, 0),
  OUT  bomPriceStd          DECIMAL(20, 10)
)
  DETERMINISTIC
proc: BEGIN
  ...
  SET bomPriceStd = v_Price;
END$$


DROP FUNCTION IF EXISTS bomPriceStd
$$

CREATE FUNCTION bomPriceStd (
